...
namespace MonoGame.Effect.TPGParser
{
    #region ParseTree
    [Serializable]
    class ParseErrors : List<ParseError>
    {
    }
    ...
    partial class ParseNode
    {
        ...
        protected virtual object? EvalTechnique_Declaration(ParseTree tree, params object[] paramlist)
        {
           ...
           {
              var shaderInfo = (ShaderInfo)paramlist[0];
        ...
        {
            ((PassInfo)paramlist[0]).CullMode = (CullMode)this.GetValue(tree, TokenType.CullModes, 0)!; return null;
        }

        protected virtual object? EvalRender_State_FillMode(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).FillMode = (FillMode)this.GetValue(tree, TokenType.FillModes, 0)!; return null;
        }

        protected virtual object? EvalRender_State_AlphaBlendEnable(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).AlphaBlendEnable = ParseTreeTools.ParseBool((string)this.GetValue(tree, TokenType.Boolean, 0)!); return null;
        }

        protected virtual object? EvalRender_State_SrcBlend(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).SrcBlend = (Blend)this.GetValue(tree, TokenType.Blends, 0)!; return null;
        }

        protected virtual object? EvalRender_State_DestBlend(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).DestBlend = (Blend)this.GetValue(tree, TokenType.Blends, 0)!; return null;
        }

        protected virtual object? EvalRender_State_BlendOp(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).BlendOp = (BlendFunction)this.GetValue(tree, TokenType.BlendOps, 0)!; return null;
        }

        protected virtual object? EvalRender_State_ColorWriteEnable(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).ColorWriteEnable = (ColorWriteChannels)this.GetValue(tree, TokenType.ColorsMasks, 0)!; return null;
        }

        protected virtual object? EvalRender_State_DepthBias(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).DepthBias = ParseTreeTools.ParseFloat((string)this.GetValue(tree, TokenType.Number, 0)!); return null;
        }

        protected virtual object? EvalRender_State_SlopeScaleDepthBias(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).SlopeScaleDepthBias = ParseTreeTools.ParseFloat((string)this.GetValue(tree, TokenType.Number, 0)!); return null;
        }

        protected virtual object? EvalRender_State_ZEnable(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).ZEnable = ParseTreeTools.ParseBool((string)this.GetValue(tree, TokenType.Boolean, 0)!); return null;
        }

        protected virtual object? EvalRender_State_ZWriteEnable(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).ZWriteEnable = ParseTreeTools.ParseBool((string)this.GetValue(tree, TokenType.Boolean, 0)!); return null;
        }

        protected virtual object? EvalRender_State_ZFunc(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).DepthBufferFunction = (CompareFunction)this.GetValue(tree, TokenType.CmpFunc, 0)!; return null;
        }

        protected virtual object? EvalRender_State_MultiSampleAntiAlias(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).MultiSampleAntiAlias = ParseTreeTools.ParseBool((string)this.GetValue(tree, TokenType.Boolean, 0)!); return null;
        }

        protected virtual object? EvalRender_State_ScissorTestEnable(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).ScissorTestEnable = ParseTreeTools.ParseBool((string)this.GetValue(tree, TokenType.Boolean, 0)!); return null;
        }

        protected virtual object? EvalRender_State_StencilEnable(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).StencilEnable = ParseTreeTools.ParseBool((string)this.GetValue(tree, TokenType.Boolean, 0)!); return null;
        }

        protected virtual object? EvalRender_State_StencilFail(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).StencilFail = (StencilOperation)this.GetValue(tree, TokenType.StencilOp, 0)!; return null;
        }

        protected virtual object? EvalRender_State_StencilFunc(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).StencilFunc = (CompareFunction)this.GetValue(tree, TokenType.CmpFunc, 0)!; return null;
        }

        protected virtual object? EvalRender_State_StencilMask(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).StencilMask = ParseTreeTools.ParseInt((string)this.GetValue(tree, TokenType.Number, 0)!); return null;
        }

        protected virtual object? EvalRender_State_StencilPass(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).StencilPass = (StencilOperation)this.GetValue(tree, TokenType.StencilOp, 0)!; return null;
        }

        protected virtual object? EvalRender_State_StencilRef(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).StencilRef = ParseTreeTools.ParseInt((string)this.GetValue(tree, TokenType.Number, 0)!); return null;
        }

        protected virtual object? EvalRender_State_StencilWriteMask(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).StencilWriteMask = ParseTreeTools.ParseInt((string)this.GetValue(tree, TokenType.Number, 0)!); return null;
        }

        protected virtual object? EvalRender_State_StencilZFail(ParseTree tree, params object[] paramlist)
        {
            ((PassInfo)paramlist[0]).StencilZFail = (StencilOperation)this.GetValue(tree, TokenType.StencilOp, 0)!; return null;
        }
        ...
        protected virtual object? EvalPass_Declaration(ParseTree tree, params object[] paramlist)
        {
           ...
           {
              var technique = (TechniqueInfo)paramlist[0];
        ...
        {
            ((SamplerStateInfo)paramlist[0]).TextureName = (string)this.GetValue(tree, TokenType.Identifier, 0)!; return null;
        }

        protected virtual object? EvalSampler_State_MinFilter(ParseTree tree, params object[] paramlist)
        {
            ((SamplerStateInfo)paramlist[0]).MinFilter = (TextureFilterType)this.GetValue(tree, TokenType.TextureFilter, 0)!; return null;
        }

        protected virtual object? EvalSampler_State_MagFilter(ParseTree tree, params object[] paramlist)
        {
            ((SamplerStateInfo)paramlist[0]).MagFilter = (TextureFilterType)this.GetValue(tree, TokenType.TextureFilter, 0)!; return null;
        }

        protected virtual object? EvalSampler_State_MipFilter(ParseTree tree, params object[] paramlist)
        {
            ((SamplerStateInfo)paramlist[0]).MipFilter = (TextureFilterType)this.GetValue(tree, TokenType.TextureFilter, 0)!; return null;
        }

        protected virtual object? EvalSampler_State_Filter(ParseTree tree, params object[] paramlist)
        {
            ((SamplerStateInfo)paramlist[0]).Filter = (TextureFilterType)this.GetValue(tree, TokenType.TextureFilter, 0)!; return null;
        }

        protected virtual object? EvalSampler_State_AddressU(ParseTree tree, params object[] paramlist)
        {
            ((SamplerStateInfo)paramlist[0]).AddressU = (TextureAddressMode)this.GetValue(tree, TokenType.AddressMode, 0)!; return null;
        }

        protected virtual object? EvalSampler_State_AddressV(ParseTree tree, params object[] paramlist)
        {
            ((SamplerStateInfo)paramlist[0]).AddressV = (TextureAddressMode)this.GetValue(tree, TokenType.AddressMode, 0)!; return null;
        }

        protected virtual object? EvalSampler_State_AddressW(ParseTree tree, params object[] paramlist)
        {
            ((SamplerStateInfo)paramlist[0]).AddressW = (TextureAddressMode)this.GetValue(tree, TokenType.AddressMode, 0)!; return null;
        }

        protected virtual object? EvalSampler_State_BorderColor(ParseTree tree, params object[] paramlist)
        {
            ((SamplerStateInfo)paramlist[0]).BorderColor = ParseTreeTools.ParseColor((string)this.GetValue(tree, TokenType.HexColor, 0)!); return null;
        }

        protected virtual object? EvalSampler_State_MaxMipLevel(ParseTree tree, params object[] paramlist)
        {
            ((SamplerStateInfo)paramlist[0]).MaxMipLevel = ParseTreeTools.ParseInt((string)this.GetValue(tree, TokenType.Number, 0)!); return null;
        }

        protected virtual object? EvalSampler_State_MaxAnisotropy(ParseTree tree, params object[] paramlist)
        {
            ((SamplerStateInfo)paramlist[0]).MaxAnisotropy = ParseTreeTools.ParseInt((string)this.GetValue(tree, TokenType.Number, 0)!); return null;
        }

        protected virtual object? EvalSampler_State_MipLodBias(ParseTree tree, params object[] paramlist)
        {
            ((SamplerStateInfo)paramlist[0]).MipMapLevelOfDetailBias = ParseTreeTools.ParseFloat((string)this.GetValue(tree, TokenType.Number, 0)!); return null;
        }
	...
	sampler.Name = (string)this.GetValue(tree, TokenType.Identifier, 0)!;
