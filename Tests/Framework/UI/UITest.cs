...
namespace MonoGame.Tests.Framework.UI
{
    public class UITest
    {
        ...
        {
            var texture = (Texture2D)RuntimeHelpers.GetUninitializedObject(typeof(Texture2D));
            texture.width = 100; texture.height = 100;
        ...
        {
            var normal = (Texture2D)RuntimeHelpers.GetUninitializedObject(typeof(Texture2D));
            normal.width = 10; normal.height = 10;
        ...
        {
            var normal = (Texture2D)RuntimeHelpers.GetUninitializedObject(typeof(Texture2D));
            normal.width = 200; normal.height = 100;
            var focused = (Texture2D)RuntimeHelpers.GetUninitializedObject(typeof(Texture2D));
            focused.width = 50; focused.height = 50;
        ...
        {
            var texture = (Texture2D)RuntimeHelpers.GetUninitializedObject(typeof(Texture2D));
            texture.width = 96; texture.height = 48;
